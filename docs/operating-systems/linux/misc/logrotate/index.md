...
Most services will generate a standard `logrotate` file in `/etc/logrotate.d` when installed, however you may wish to implement custom ones such as the following example.
