...
The next step is to check the changes were successful, this can be done by going back to the ['View the current hostname'](./#view-the-current-hostname) section.
