---
sidebar_position: 1
sidebar_label: "How to set up a Multi-Protocol VPN Server using SoftEther"
...
You can download the latest SoftEther server package for Linux from [their website](http://www.softether-download.com/en.aspx).
...
```bash
wget http://www.softether-download.com/../../../operating-systems-images/softether/v4.20-9608-rtm-2016.04.17-tree/Linux/SoftEther_VPN_Server/64bit_-_Intel_x64_or_AMD64/softether-vpnserver-v4.20-9608-rtm-2016.04.17-linux-x64-64bit.tar.gz
```
...
![pic1](../../../operating-systems-images/install_softether_vpn_server-1.png)
...
Check out this link for a guide on using Certbot to automate generating Let's Encrypt certificates: [SafeDNS Authenticator plugin for Certbot](../../../../domains-and-dns-management/safedns/certbot-plugin/).

- [Further reading on Certbot](https://certbot.eff.org/docs/using.html)
...
:::note
If you already have an SSL certificate or you have created one using `openssl`, it can be added to the server using the command `ServerCertSet` as shown above, changing the paths to match where your files are.
:::

Now that we have created and registered an SSL Certificate for our server, we can enable SSTP function with this command:
...
![pic2](../../../operating-systems-images/install_softether_vpn_server-2.png)
...
![pic3](../../../operating-systems-images/install_softether_vpn_server-3.png)

### Step 2: Set up a new connection or network

Click **Set up a new connection or network**.

![pic4](../../../operating-systems-images/install_softether_vpn_server-4.png)

### Step 3: Connect to a workplace

In the appeared window select **Connect to a workplace**, click **Next**.

![pic5](../../../operating-systems-images/install_softether_vpn_server-5.png)

### Step 4: Set as VPN

Click **Use my Internet connection (VPN)**.

![pic6](../../../operating-systems-images/install_softether_vpn_server-6.png)
...
![pic7](../../../operating-systems-images/install_softether_vpn_server-7.png)
...
![pic8](../../../operating-systems-images/install_softether_vpn_server-8.png)

### Step 7: Create the connection

Click **Close**.

![pic9](../../../operating-systems-images/install_softether_vpn_server-9.png)

### Step 8: Find the new connection

Click **Change adapter settings**.

![pic10](../../../operating-systems-images/install_softether_vpn_server-10.png)
...
![pic11](../../../operating-systems-images/install_softether_vpn_server-11.png)
...
![pic12](../../../operating-systems-images/install_softether_vpn_server-12.png)

### Step 11: Start the VPN connection

Double click on the **OpenStack VPN** connection icon, or whatever you called yours.

![pic13](../../../operating-systems-images/install_softether_vpn_server-13.png)
...
![pic14](../../../operating-systems-images/install_softether_vpn_server-14.png)
...
![pic15](../../../operating-systems-images/install_softether_vpn_server-15.png)
