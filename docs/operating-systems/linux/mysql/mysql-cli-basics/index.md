---
sidebar_position: 4
sidebar_label: "MySQL command line basics"
...
For more tips on managing users and databases, please do check out our [Managing Databases and Users](../managing-databases-users/) guide.
