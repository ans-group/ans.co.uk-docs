---
sidebar_position: 15
sidebar_label: "Service management on CentOS 6"
...
To keep in the scope of this tutorial as part of a [Linux basics](../index.md) series, we'll only be covering two of the most common services you'll come across when managing a Linux web server, `Apache` and `MySQL`
