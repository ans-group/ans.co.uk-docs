---
sidebar_position: 1
sidebar_label: "Add a new disk to the server"
...
When increasing the amount of disk space assigned to an eCloud virtual machine (VM), the simplest method is to add a new disk to the VM via [ANS Glass](https://ans.glass), and then add that disk into the Volume Group and Logical Volume for the `/` partition.
...
If you're unsure of anything or need some help, please contact ANS Support, by raising a ticket in [ANS Glass](https://ans.glass/support-and-help/incidents) or calling 0800 230 0032.
:::

## Identifying new disk

From ANS Glass, you will need to first add a new disk to your VM using the eCloud interface for your required VM. This will hot-add a new disk to your server.
