---
sidebar_position: 2
sidebar_label: "Resize the primary disk (suggested)"
...
# Resize the primary disk _(suggested)_
...
**This article is for those comfortable with Linux administration.** If you're not comfortable with Linux and want to increase the amount of disk space assigned to your server, ANS customers may raise a support ticket on ANS Glass.
:::

### Resize the disk in ANS Glass
...
The first step from here is to resize the disk in the ANS Glass portal. This can be done by visiting:

```
ANS Glass -> eCloud -> Public/Private/Hybrid -> [Click the server]
```
