---
sidebar_position: 4
sidebar_label: "Connecting to your server via SSH"
...
This will then prompt you for a password, which is the root password sent to you when you first opened your account with ANS.
...
![Connecting](../../../operating-systems-images/connecting1.png)
...
For further advice on what to do once you've connected in this fashion, you could refer to our other documentation in the [Linux basics](../index.md) range. Alternatively, there are a multitude of resources out there on the internet.
...
![Private key](../../../operating-systems-images/PuTTY1.png)
