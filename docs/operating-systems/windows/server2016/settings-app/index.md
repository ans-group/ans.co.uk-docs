---
sidebar_position: 3
sidebar_label: "The new Settings app"
...
The Time & language category contains the following sections:
...
The Update & security category contains the following important sections:
