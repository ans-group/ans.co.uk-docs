---
sidebar_position: 10
sidebar_label: "Protecting against Meltdown & Spectre in Windows"
...
# Protecting against Meltdown & Spectre in Windows
...
![Server 2012 R2 Manual Download](../../../operating-systems-images/2012r2-UpdateCatalog1.png)
...
![Server 2012 R2 Manual Install](../../../operating-systems-images/2012r2-UpdateCatalog2.png)

![Server 2012 R2 Manual Install2](../../../operating-systems-images/2012r2-UpdateCatalog3.png)

Run through the installation. When complete, you will need to reboot your machine for the patch to take effect.

![Server 2012 R2 Install Completion](../../../operating-systems-images/2012r2-installcomplete.png)
...
Open a `CMD Prompt` as Administrator and run the following two commands, one after another. This will add the relevant registry keys to enable the mitigation. Always backup the registry before making changes. If you are an ANS customer and are not comfortable making these changes, please seek assistance from our support team by raising a support request in [ANS Glass](https://ans.glass/support-and-help/incidents).
...
Once testing has been completed, this security patch will be deployed automatically for any ANS customers who follow our automatic update schedule and have a compatible anti-virus, as per the Microsoft patch requirements. The patch will be pushed out through the standard Windows Update system.
...
If you don't have automatic updates scheduled on your ANS servers, here's how to check for Windows Server updates manually.
...
![Server 2012 R2 Windows Updates](../../../operating-systems-images/2012r2-controlAlt.png)
...
![Server 2012 R2 Check Updates](../../../operating-systems-images/2012r2-control4.png)

### Windows Server 2016

- Click `Start` and type `Windows Update` in the search bar.

![Server 2016 Start Menu](../../../operating-systems-images/2016-WindowsUpdate1.png)

![Server 2016 Windows Updates](../../../operating-systems-images/2016-WindowsUpdate2.png)

- Click on `Windows Update Settings`, from here you can check for any new updates.

![Server 2016 Check Updates](../../../operating-systems-images/2016-WindowsUpdate3.png)
