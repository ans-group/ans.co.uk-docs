---
sidebar_position: 6
sidebar_label: "How to free up hard disk space on your Windows Server"
...
If you are unable to discover what is responsible for the space consumption, you can use a tool such as `TreeSize` which is a disk space analyser that can be downloaded for free below:
