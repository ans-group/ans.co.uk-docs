---
sidebar_position: 1
sidebar_label: "How to transfer files to and from a server"
...
![rdpcopy](../../../operating-systems-images/rdpcopy.png)

![rdpcopy](../../../operating-systems-images/rdppaste.png)
...
![FileZilla component selection](../../../operating-systems-images/choosecomponentstrimmed.png)
...
![FileZilla server settings](../../../operating-systems-images/startupsettingstrimmed.png)
...
![FileZilla server settings 2](../../../operating-systems-images/startupsettings2trimmed.png)
...
![FileZilla install complete](../../../operating-systems-images/installcompletetrimmed.png)
...
![Edit/Users](../../../operating-systems-images/edituserstrimmed.png)
...
![Add User](../../../operating-systems-images/usersgeneraltrimmed.png)
...
![User Added](../../../operating-systems-images/useraddedtrimmed.png)
...
:::note
You can only select single directories in this menu, and you will need to repeat this step for each directory that you wish to grant access to.
:::

![Add Share](../../../operating-systems-images/sharedfoldersaddsharetrimmed.png)
...
:::note
These permissions are set on a per directory and per user basis, in order to set appropriate permissions for other users, you will need to first select the user on the Users Pane, and then select the share for that user which you wish to change the permissions for.
:::

![FTP permissions](../../../operating-systems-images/shareaddedtrimmed.png)
...
![Licence agreement](../../../operating-systems-images/installationpane1trimmed.png)
...
![Installation options](../../../operating-systems-images/installationoptionstrimmed.png)
...
![components](../../../operating-systems-images/choosecomponentstrimmed.png)
...
![install location](../../../operating-systems-images/chooseinstalllocationtrimmed.png)
...
![Install complete](../../../operating-systems-images/installationcompletetrimmed.png)
...
![Ftp Client start](../../../operating-systems-images/startmenufilezilla.png)
...
![Ftp console](../../../operating-systems-images/ftpclient.png)
...
![Ftp connected](../../../operating-systems-images/ftpclientconnected.png)
