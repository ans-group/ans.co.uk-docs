---
sidebar_position: 9
sidebar_label: "Changing Windows updates installation options"
...
This option is similar to the one explained above - however the updates will download automatically. It's important to note that, whilst the updates will download automatically, they _won't_ install automatically. This still requires manual intervention to install the updates.
