---
sidebar_position: 4
sidebar_label: "TLS support for Windows software"
...
The Remote Desktop Protocol (RDP) on Windows Servers 2012 R2 and newer fully supports TLS 1.2 encryption. If using an older operating system, such as Server 2008 R2, then you may need to apply Windows patches to [enable RDP to use TLS 1.1 and TLS 1.2](../web-server-recommendations/#windows-server-2008-r2--2012).
