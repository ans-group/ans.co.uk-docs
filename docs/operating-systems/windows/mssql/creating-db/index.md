---
sidebar_position: 5
sidebar_label: "Creating a new database in Microsoft SQL Server"
...
:::note
This guide assumes that you already have [MSSQL Management studio installed](../which-sql/), and that you are [connected to your database](../connecting/). If this is not the case, and you are unsure of how to go about this, please follow our respective guides on those subjects.
:::
