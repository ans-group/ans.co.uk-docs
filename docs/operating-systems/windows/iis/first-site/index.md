---
sidebar_position: 2
sidebar_label: "Setting up your first site in IIS"
...
- For the Binding section, select the type of traffic that you wish to create a binding for, i.e HTTP or HTTPS. Select the IP and port which you would like the site to listen on. Finally, add the hostname of your site, in this example `contoso.test`.

The `Add Website` pane should now look very similar to the example below:

![New Site Details](../../../operating-systems-images/newsitedetailstrimmed.png)
