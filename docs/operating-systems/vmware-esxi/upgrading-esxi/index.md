---
sidebar_position: 1
sidebar_label: "Update or upgrade standalone ESXi servers"
...
Standalone ESXi servers can also be updated or upgraded via SSH. You don't _need_ to have a vCenter server, it just makes it easier.
