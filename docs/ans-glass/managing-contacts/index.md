---
sidebar_position: 2
sidebar_label: "Managing contacts & permissions in ANS Glass"
title: "Managing contacts & permissions in ANS Glass"
...
# Managing contacts & permissions in ANS Glass
...
If the existing Primary Contact has left the company, please contact your Account Manager who can facilitate changing the Primary Contact. You can find all of their contact details on the ANS Team pod on your [ANS Glass Dashboard](https://ans.glass) or [360](https://ans.glass/customer-360) screen.
...
On this page a contact can be limited to only being able to log in to [ANS Glass](https://ans.glass) from certain IP addresses and can have an pre-set **Access Profile** selected or a customised one set up to fine tune the type of access this contact has.
