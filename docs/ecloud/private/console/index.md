...
![console button public](../../ecloud-private-images/console/ConsoleButtonPublicVM.png)

For Private and Hybrid VM clients, that button can be found (highlighted in green in this screenshot) here:

![console button private](../../ecloud-private-images/console/ConsoleButtonPrivateVM.png)
