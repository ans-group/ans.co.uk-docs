...
![launch appliance](../../ecloud-public-images/marketplace/launchAppliance.png)
...
![appliance config](../../ecloud-public-images/marketplace/applianceConfig.png)

Once the specification is set you can then select to create appliance.

![create button](../../ecloud-public-images/marketplace/createbutton.png)
