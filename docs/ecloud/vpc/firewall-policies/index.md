...
![firewall policies](../../vpc-images/firewall-policies/firewall-policies.png)

## Create a policy - set the name for your first policy and hit the create button.

![firewall policies create](../../vpc-images/firewall-policies/firewall-policies-create.png)
...
![firewall policies rules create](../../vpc-images/firewall-policies/firewall-policies-rules-create.png)

![firewall policies example](../../vpc-images/firewall-policies/firewall-policies-example.png)

Add further policies & rules as you need.

![firewall policies example 2](../../vpc-images/firewall-policies/firewall-policies-example2.png)
