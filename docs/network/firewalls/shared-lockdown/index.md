---
sidebar_position: 4
sidebar_label: "How to secure your shared firewall"
title: How to secure your shared firewall
---
...
![Add an admin IP](../../networking-images/shared_admin_ip.png)
...
There are some situations where the best solution is to block an IP entirely. On the ANS shared firewall you can do this under the Block Config tab of your firewall interface. It looks like this:

![Block an IP on shared firewall](../../networking-images/shared_block_ip.png)

You can simply add a single IP and click `Save Changes`, and any future connections from that IP will be dropped by your firewall.

Our interface also allows you to add subnet ranges. If you are not familiar with how subnets work, they basically allow you to block a number of IPs in the same subnet range, by using a subnet mask. While it's possible to learn how to do these ranges by hand, it is easy to use the many online tools, like this one from [MXtoolbox](https://mxtoolbox.com/subnetcalculator.aspx).

:::warning
ANS is not responsible for the performance of 3rd party software or testing tools.
:::
