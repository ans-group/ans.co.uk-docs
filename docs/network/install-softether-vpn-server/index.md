...
```bash
wget http://www.softether-download.com/../networking-images/softether/v4.20-9608-rtm-2016.04.17-tree/Linux/SoftEther_VPN_Server/64bit_-_Intel_x64_or_AMD64/softether-vpnserver-v4.20-9608-rtm-2016.04.17-linux-x64-64bit.tar.gz
```
...
![pic1](../networking-images/install_softether_vpn_server-1.png)
...
If you would like SoftEther to start as a service on start-up create a file named `vpnserver` in `/etc/init.d` directory a follows.
...
![pic2](../networking-images/install_softether_vpn_server-2.png)
...
![pic3](../networking-images/install_softether_vpn_server-3.png)

### Step 2: Set up a new connection or network

Click **Set up a new connection or network**.

![pic4](../networking-images/install_softether_vpn_server-4.png)

### Step 3: Connect to a workplace

In the appeared window select **Connect to a workplace**, click **Next**.

![pic5](../networking-images/install_softether_vpn_server-5.png)

### Step 4: Set as VPN

Click **Use my Internet connection (VPN)**.

![pic6](../networking-images/install_softether_vpn_server-6.png)
...
![pic7](../networking-images/install_softether_vpn_server-7.png)
...
![pic8](../networking-images/install_softether_vpn_server-8.png)

### Step 7: Create the connection

Click **Close**.

![pic9](../networking-images/install_softether_vpn_server-9.png)

### Step 8: Find the new connection

Click **Change adapter settings**.

![pic10](../networking-images/install_softether_vpn_server-10.png)
...
![pic11](../networking-images/install_softether_vpn_server-11.png)
...
![pic12](../networking-images/install_softether_vpn_server-12.png)

### Step 11: Start the VPN connection

Double click on the **OpenStack VPN** connection icon, or whatever you called yours.

![pic13](../networking-images/install_softether_vpn_server-13.png)
...
![pic14](../networking-images/install_softether_vpn_server-14.png)
...
![pic15](../networking-images/install_softether_vpn_server-15.png)
