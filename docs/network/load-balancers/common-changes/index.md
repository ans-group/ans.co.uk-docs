...
Navigate to the load balancer you want to add the new target server to in ANS Glass then click on `Target Groups` at the top of the load balancer screen:

![Target Group Tab](../../networking-images/inactive_target_1_small.png)

Click the target group you want to add the target to.

![Target Group Listview](../../networking-images/inactive_target_2_small.png)

Click the `Targets` tab at the top of the screen.

![Target Group Overview](../../networking-images/inactive_target_3_small.png)

Click `Create Target` at the top right of the screen.

![Targets Listview](../../networking-images/create_target_1_small.png)

Fill the form in with the new target server's IP address and port. If it is an ANS server you will be able to search for and select the server IP when you click the IP field. You can also give the target server an optional name to help you remember which server it is.
...
![Target Create Screen](../../networking-images/create_target_2_small.png)
...
![Targets Listview](../../networking-images/create_target_3_small.png)
...
![Deployment Screen](../../networking-images/inactive_target_7_small.png)

## Replacing an expired SSL certificate

SSL certificates have expiry dates which once reached will start to show security errors to users visiting the website. You can easily replace your load balancer's SSL certificates with a new one when they expire within ANS Glass.

Firstly open the affected load balancer within ANS Glass, then click on `Listeners` at the top of the overview screen.

![Listeners Tab](../../networking-images/expired_ssl_1_small.png)

Click the listener which is affected by the expired SSL, followed by the `SSLs` tab.

![Listeners Overview](../../networking-images/expired_ssl_2_small.png)

![SSLs Tab](../../networking-images/expired_ssl_3_small.png)
...
![Delete SSL](../../networking-images/expired_ssl_4_small.png)

Click the `Create SSL` button in the top right of the screen and fill in the form with your new SSL certificate details. If the certificate has been bought within ANS Glass you can choose `Import ANS Certificate`, select the certificate and have the details filled in automatically. Once the form is complete, press save.

![Create SSL Button](../../networking-images/expired_ssl_5_small.png)

![Create SSL Form](../../networking-images/expired_ssl_6_small.png)
...
![Create SSL Success](../../networking-images/expired_ssl_7_small.png)

![Deployment Screen](../../networking-images/expired_ssl_8_small.png)
...
Navigate to the load balancer you want to edit in ANS Glass then click on `Target Groups` at the top of the load balancer screen
...
![Targets Listview](../../networking-images/drain_target_1_small.png)

Change the "Weight" field to `0`, then press save at the bottom of the screen.

![Target Edit Screen](../../networking-images/drain_target_2_small.png)
...
![Targets Listview](../../networking-images/drain_target_3_small.png)
...
![Targets Listview](../../networking-images/inactive_target_4_small.png)

Uncheck the "Target is Active" box near the bottom of the form, then press save.

![Target Edit Screen](../../networking-images/inactive_target_5_small.png)
...
![Targets Listview](../../networking-images/inactive_target_6_small.png)
