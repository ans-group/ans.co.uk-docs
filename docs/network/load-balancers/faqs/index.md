...
This is covered in our [common changes](../common-changes/#replacing-an-expired-ssl-certificate) page.

## How do I drain traffic from a particular target server?

This is covered in our [common changes](../common-changes/#drain-traffic-from-a-particular-target-server) page.

This is covered in our [common changes](../common-changes/#temporarily-remove-a-target-server-from-behind-the-load-balancer) page.
