...
If you're one of our Linux clients, you can still follow the non-ANS section if you'd like, but we've implemented an easier patching process through your [ANS Glass](https://ans.glass) client area.

Once you've followed that link and logged in, you should be confronted with something like this:

![server package updates](../security-images/dirtycow1.jpg)
...
![Reboot servers](../security-images/dirtycow2.jpg)
