...
This page relates to hardware-based WAFs only.

Typically WAFs suffer from very few problems as long as they have been [set up correctly](../getting-started/).
...
- **WAF isn't blocking any traffic:** This is most likely due to the WAF being in [learning mode](../getting-started/#learning-phase). Contact ANS immediately to have the WAF fully switched-on.
...
If you experience any problems with your WAF then please contact support or raise a ticket via [ANS Glass](https://ans.glass).
