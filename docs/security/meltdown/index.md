---
sidebar_position: 13
sidebar_label: "Meltdown & Spectre"
...
[Protecting against Meltdown and Spectre in Windows](../../operating-systems/windows/windows-administration/meltdown-spectre-patch/).
...
If you're a Linux customer of ANS, we've implemented an easy patching process through [ANS Glass](https://ans.glass). Alternatively you could also follow the Non-ANS customers process set out below.

Once you're logged into ANS Glass you will see something like this:

![Patching page](../security-images/dirtycow1.jpg)
...
![Pending reboot](../security-images/dirtycow2.jpg)
