...
With this information in hand, you can initiate the transfer in process via ANS Glass. This can be found in `Domains` > `Transfer in`, or follow the link [here](https://portal.ans.co.uk/domains/transfer-in.php).

You should see a page like this:

![domain transfer](../../domains-images/transfer1.png)
