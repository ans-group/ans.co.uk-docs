...
Each registry allows a user to query their database of domain names via the [WHOIS](../what-is-whois/) system, which lets users to check availability or find out who owns a particular domain.
