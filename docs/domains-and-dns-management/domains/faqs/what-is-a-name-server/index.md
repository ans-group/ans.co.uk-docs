...
The name servers therefore allow you to see who currently manages a domain name’s DNS. If you are using ANS's SafeDNS your nameservers need to point to our name servers so that any changes you make to your DNS take effect.
