...
If you want to change the registrant for `.uk` domains you or the new registrant need to complete a form with [Nominet](../who-are-nominet/) - the internet registry for the `.uk` domain extensions. To do this you need to log in to your Nominet Online Services account and select the `Registrant Transfer` service.
