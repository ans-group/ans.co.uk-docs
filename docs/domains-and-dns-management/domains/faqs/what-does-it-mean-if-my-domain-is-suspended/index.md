...
If your domain is with ANS and you want to remove the suspension you can resend the validation email to yourself in the `View Domain Overview` screen in ANS Glass. You can also change the email address that receives the email from the `View Domain Registrant` screen.
