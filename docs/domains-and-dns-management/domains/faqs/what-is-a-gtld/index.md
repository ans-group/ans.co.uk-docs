...
gTLDs (or generic top-level domain names) are the most common kind of top-level [domain names](../what-is-a-domain-name), and the ones we’re most used to seeing. They function as part of the internet system we use to help us map and remember a website’s numerical IP addresses - also called the Domain Name System (DNS). gTLDs have three or more characters and follow the ‘dot’ part of the address e.g. `.com`, `.org`, etc.
