...
ICANN, short for ‘The Internet Corporation for Assigned Names and Numbers’, are a not-for-profit organisation that controls the rules and regulations with regards to [domain names](../what-is-a-domain-name/).

They regulate the registration and the use of domain names for the [Generic Top Level Domains](../what-is-a-gtld/), such as `.com`, `.net` or `.org`, and are in the process of rolling out a huge number of new TLDs.
