...
If you’re using SafeDNS from ANS, follow the steps in [this article](../../safedns/add-new-domain/) to add your domain, along with the IP address you wish to point the domain to. Repeat this for each of the domain.
...
- [cPanel](https://api.docs.cpanel.net/#InstallanSSLCertificateonaDomain-SNIandmultiplecertificates)
