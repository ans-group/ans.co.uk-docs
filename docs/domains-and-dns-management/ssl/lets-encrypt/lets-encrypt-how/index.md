...
A limitation of this challenge is you cannot request [wildcard certificates](../../types).
...
This can be useful if your service is not accessible over port **80**, or if you have multiple web servers to cover. This challenge method also allows for you to issue [wildcard certificates](../../types/), along with [CNAME challenge delegation](https://www.eff.org/deeplinks/2018/02/technical-deep-dive-securing-automation-acme-dns-challenge-validation)

If using an API, such as our [SafeDNS API](../../../safedns/safedns-api/), this is quick and easy to add and to automate.
