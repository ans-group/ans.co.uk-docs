...
You can check what they are currently by running a WHOIS test in the ANS Glass. If your domain is registered with a 3rd party, you will need to change the nameservers by logging into their portal; if your domain is registered at ANS, please see [this guide](../../domains/changing-name-servers/) on how to change the nameservers.
