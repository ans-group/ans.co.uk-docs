...
You can obtain the API key from your ANS Glass account page. See also the [SafeDNS API](../safedns-api/) documentation.
...
:::warning
You should protect these API credentials as you would the password to your ANS account. Users who can read this file can use these credentials to issue arbitrary API calls on your behalf. Users who can cause Certbot to run using these credentials can complete a `dns-01` challenge to acquire new certificates or revoke existing certificates for associated domains, even if those domains aren’t being managed by this server.
:::
