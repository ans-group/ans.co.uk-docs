...
Also note that there are a number of different factors that can affect the total propagation time of DNS record changes. Please see [“What factors affect DNS propagation time?”](../../domains/dns-propagation/) for more information.
