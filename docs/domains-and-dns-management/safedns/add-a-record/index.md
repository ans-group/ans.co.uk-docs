...
Before you can add a subdomain or an `A` record to your domain, you must login to the ANS Glass client area and access the SafeDNS service, which can be located under the `Services` drop-down menu at the top of the client area.
...
![add A record](../../domains-images/addarecord1.png)

You will presented with a series of fields, as such:

![add A record](../../domains-images/addarecord2.png)
