---
sidebar_position: 1
sidebar_label: "PROprotection report"
title: PROprotection report
...
A PROprotection report gives a consolidated view of various usage and performance metrics related to your ANS-hosted servers.

Follow these steps to run a PROprotection report:

1. Login to [ANS Glass](https://ans.glass) and go to `Dedicated Servers` in the `Products and Services` menu.
