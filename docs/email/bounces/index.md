...
To configure it, log in to [ANS Glass](https://ans.glass) and go to the server in question, where you will see a page like this:

![Reverse DNS](../email-images/rdns.png)
...
[Configuring SPF Records](../../domains-and-dns-management/safedns/spf/).

## Further guidance

Please read our [documentation on email blocklists](../blocklists/) as well as the [basics of email](../mail-config/) to ensure you get everything set up properly to begin with.
