...
![Mail tester](../email-images/Mailtester1.png)
...
![Mail tester 2](../email-images/Mailtester2.png)
...
![Mail tester 3](../email-images/Mailtester3.png)
...
Sender Policy Framework (SPF) records allow the recipient to check that your mail is authentic. The SPF record defines which mail servers are allowed to send from your domain (such as `@ans.co.uk`).
...
![Mail tester 4](../email-images/Mailtester4.png)
