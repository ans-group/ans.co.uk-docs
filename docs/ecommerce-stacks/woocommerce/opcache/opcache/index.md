...
You can then browse `www.shopwaredomain.com/opcache-gui`. We recommend password / IP redirection for this URI. You can do this following our guide on [restricting file access](../../../magento/magento-2/restrict-file-folder).
