...
:::note
You can copy and paste the whole block below into your SSH terminal.
:::
...
You can find more information on OPcache [here](../../opcache/).
...
You can find more information on APCu [here](../../apcu/).
