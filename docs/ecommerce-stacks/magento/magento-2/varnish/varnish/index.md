...
You can view an example Magento 2 ANS `VCL` [here](../ans-vcl/).
...
You can also set this via the Magento 2 CLI:
...
The Magento generated VCL has the following health check:
