...
At ANS on our Magento optimised hosting platforms we configure three different instances of Redis running on different ports:
...
ANS will install and configure your Redis instances so you can begin enabling this in Magento as soon as you are ready.
...
- `Cm_RedisSession` - [https://github.com/colinmollenhour/Cm_RedisSession](https://github.com/colinmollenhour/Cm_RedisSession)
...
Colin Mollenhour's repository also provides scripts to enable you to do this. Depending on whether you were previously using files or database to store sessions you can follow the steps below.
...
[Here's more information on the Redis service](../../../../../operating-systems/linux/redis/)
