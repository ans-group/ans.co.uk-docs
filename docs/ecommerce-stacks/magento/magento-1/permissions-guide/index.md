---
sidebar_label: "Permissions guide"
sidebar_position: 1
---
...
:::note
The following information is for ANS Magento 1 optimised servers running on the NGINX webservice - this guide is for NGINX only.
