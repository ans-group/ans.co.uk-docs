...
FASTcloudbackup is a file and folder backup solution, based on Commvault technology. It’s designed to backup computers and servers running Linux, Windows, and Mac. For full details and pricing, visit the [ANS website](https://www.ans.co.uk/cloud-services/managed-hosting/).
...
Data is backed up to the FASTcloudbackup platform hosted in our [Manchester-based data centres](https://www.ans.co.uk/data-centres/). We guarantee your data will never leave the UK.
...
Billing for FASTcloudbackup is based on the amount of storage quota (in gigabytes) you purchase, plus the number of computers or servers you install the FASTcloudbackup agent on to. Full pricing details are available on the [ANS website](https://www.ans.co.uk/cloud-services/managed-hosting/).
...
![reset password](../../backup-availability-images/reset_password_email.png)
