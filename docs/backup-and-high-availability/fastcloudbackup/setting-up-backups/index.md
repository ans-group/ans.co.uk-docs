---
sidebar_label: "Setting up backups"
sidebar_position: 4
---
...
From the home screen of the [FASTcloudbackup webconsole](https://fcb.ukfast.co.uk/) click on `My Data`, find the computer or server you wish to work on and then click `Settings`.
...
![content](../../backup-availability-images/Content2.png)
...
![files and folders default](../../backup-availability-images/files_folders_default.png)

Then navigate through your file structure to choose files and folders.

![browse files](../../backup-availability-images/browse_files.png)
...
![files and folders](../../backup-availability-images/files_and_folders.png)
...
![add schedule](../../backup-availability-images/add_schedule.png)
...
![amend schedule](../../backup-availability-images/amend.png)

If you stop backing up a particular computer or server, you may want to cancel any [alerts](../setting-up-alerts/) you previously had set up otherwise you will continue to receive notifications that backups have not been run.
