...
ANS Backup can be managed by selecting the server you want to manage within [ANS Glass](https://ans.glass) and selecting `Backup` from the tab menu.

![backup overview](../../backup-availability-images/backup_overview.png)
...
ANS Backup comes pre-configured with a default backup schedule which includes all data from mounted disks and excludes certain files including:
...
You can create additional rules within the [backup schedule](../backup-schedules/).
