---
sidebar_label: "Managing your cluster"
sidebar_position: 2
---
...
At the very top of the output, the `acme-webdb-01-stonith` and `acme-webdb-02-stonith` resources are listed and running on the opposing node to their name. These are used to send fence commands to recover a node from failure.
