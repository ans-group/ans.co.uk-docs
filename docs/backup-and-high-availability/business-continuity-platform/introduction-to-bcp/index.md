---
sidebar_label: "Introduction to BCP"
sidebar_position: 1
---
...
![two node bcp](../../backup-availability-images/two-node-bcp.png)
...
- http://docs.linbit.com/docs/users-guide-8.4/
- https://www.ibm.com/developerworks/library/l-drbd/index.html
  :::

#### Unison

A package called [Unison](https://www.cis.upenn.edu/~bcpierce/unison/) is used to synchronise configuration between both nodes on a schedule. This runs as a [cron](../../../operating-systems/linux/basics/cron/) job on both nodes every minute. By default it will be set to copy your webserver configuration, database server configuration, SSL certificates, and system users and passwords between the two nodes.
...
**[Continue reading about DRBD on BCP »](../unison-file-level-replication/)**
...
![four node bcp](../../backup-availability-images/four-node-bcp.png)
...
Unlike the two node clusters, [load balancers](../../../network/loadbalancing/) are used in place of a web VIP. As such, you’ll receive a VIP for the load balancer which is configured as requested to split load between the web servers, this is the address you should use in your [DNS records](../../../domains-and-dns-management/safedns/) when going live.
...
- [Information about DRBD on BCP »](../distributed-replicated-block-device-drbd/)

- [Information about Unison on BCP »](../unison-file-level-replication/)
